			...
			<div className="flex flex-wrap gap-1.5">
				{newLabel && newLabel.length > 0 ? (
					newLabel.map((tags, index) => (
						<>
							<div
								className="w-fit h-14 p-1 bg-sky-800 rounded-lg justify-center items-center gap-2.5 inline-flex border border-white relative cursor-pointer"
								key={index}
							>
								<div className="w-fit flex items-center justify-center gap-4">
									<div className="ps-6 text-white text-xl font-bold font-['Inter']">
										{tags}
									</div>
									<button
